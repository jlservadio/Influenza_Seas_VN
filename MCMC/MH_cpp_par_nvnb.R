...
if (file.num > 1) {
	...
	load(paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnb/MCMC_nvnb_0501_', file.num-1, '.Rdata', sep = ''))
	...
	# load('~/work/Infl_VN/MCMC_0501/MCMC_nvnb/MCMC_nvnb_0509.Rdata')
	load('~/work/Infl_VN/MCMC_0501/MCMC_nvnb/MCMC_nvnb_0501_0.Rdata')
...
file.name = paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnb/MCMC_nvnb_0501_', file.num, '.Rdata', sep = '')

search_params_names = c('beta_B', 'amp', 'rho_denom', 
...
mv.pars = list(c('beta_B'), c('amp'), c('rho_denom'), c('phi.1'), 
...
pp = MH_chain(ch.num = 0, chain.length = 200, 
	...
	use.cur = use.cur,
	type = 'nvnb', 
	dat = as.matrix(cbind(rep(NA, nrow(dat)), dat$ILI_p_B, rep(NA, nrow(dat))))) 
...
if (file.num >= 3) { 
	...
	all.data = list()
	load('~/work/Infl_VN/MCMC_0501/MCMC_nvnb/MCMC_nvnb_0501_1.Rdata')
	...
	for (i in 2:file.num) {
		...
		load(paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnb/MCMC_nvnb_0501_', i, '.Rdata', sep = ''))
	...
	save(all.data, file = paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnb/MCMC_nvnb_0501.Rdata', sep = ''))
...
type = 'nvnb'; source('~/work/Infl_VN/MCMC_0501/Code/plotting.R')
