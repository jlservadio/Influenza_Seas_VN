...
all_params = c(
	...
	'tau.10' = sample(c(100:650), 1), # 350, 
	'tau.11' = sample(c(100:650), 1), # 350, 
	'tau.12' = sample(c(100:650), 1), # 350, 
	'tau.13' = sample(c(100:650), 1), # 350, 
	'mu.tau' = 465, 
	'sigma.tau' = 100, 
	'report' = 0.00026, 
	'norm_var' = 0.1^2, 
...
if (file.num > 1) {
	...
	load(paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnc/MCMC_cvnc_0501_', file.num-1, '.Rdata', sep = ''))
	...
	# load('~/work/Infl_VN/MCMC_0501/MCMC_cvnc/MCMC_cvnc_0509.Rdata')
	load('~/work/Infl_VN/MCMC_0501/MCMC_cvnc/MCMC_cvnc_0501_0.Rdata')

	start.pars = list()
	for (i in 1:4) {
		ss = sample(c(1:3), 1); ss = i
...
file.name = paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnc/MCMC_cvnc_0501_', file.num, '.Rdata', sep = '')
...
if (file.num >= 3) { 
	...
	all.data = list()
	load('~/work/Infl_VN/MCMC_0501/MCMC_cvnc/MCMC_cvnc_0501_1.Rdata')
	...
	for (i in 2:file.num) {
		...
		load(paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnc/MCMC_cvnc_0501_', i, '.Rdata', sep = ''))
	...
	save(all.data, file = paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnc/MCMC_cvnc_0501.Rdata', sep = ''))
...
type = 'cvnc'; source('~/work/Infl_VN/MCMC_0501/Code/plotting.R')
