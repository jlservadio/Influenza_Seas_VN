...
load('~/work/Infl_VN/Data/NVN_Detr_Ag.Rdata')
dat = dat.north
...
if (file.num > 1) {
	...
	load(paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh3/MCMC_nvnh3_0501_', file.num-1, '.Rdata', sep = ''))
	...
	# load('~/work/Infl_VN/MCMC_0501/MCMC_nvnh3/MCMC_nvnh3_0509.Rdata')
	load('~/work/Infl_VN/MCMC_0501/MCMC_nvnh3/MCMC_nvnh3_0501_0.Rdata')
...
file.name = paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh3/MCMC_nvnh3_0501_', file.num, '.Rdata', sep = '')

search_params_names = c('beta_H3', 'amp', 'rho_denom', 
   	'phi.1', 'tau.1', 'tau.2', 'tau.3', 'tau.4', 'tau.5', 'tau.6', 'tau.7', 'tau.8', 
...
mv.pars = list(c('beta_H3'), c('amp'), c('rho_denom'), c('phi.1'), 
	c('tau.1', 'tau.2', 'tau.3', 'tau.4', 'tau.5', 'tau.6', 'tau.7','tau.8'), 
...
pp = MH_chain(ch.num = 0, chain.length = 200, 
	...
	use.cur = use.cur,
	type = 'nvnh3', 
	dat = as.matrix(cbind(rep(NA, nrow(dat)), rep(NA, nrow(dat)), dat$ILI_p_H3)))
...
if (file.num >= 3) { 
	...
	all.data = list()
	load('~/work/Infl_VN/MCMC_0501/MCMC_nvnh3/MCMC_nvnh3_0501_1.Rdata')
	...
	for (i in 2:file.num) {
		...
		load(paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh3/MCMC_nvnh3_0501_', i, '.Rdata', sep = ''))
	...
	save(all.data, file = paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh3/MCMC_nvnh3_0501.Rdata', sep = ''))
...
type = 'nvnh3'; source('~/work/Infl_VN/MCMC_0501/Code/plotting.R')
