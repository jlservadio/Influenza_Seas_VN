...
all_params = c(
	...
	'etaab' = 0.01, 
	'etaba' = 0.05, 
	'phi.1' = 129, #sample(c(1:400), 1), # 250, 
	'tau.1' = 365, #sample(c(100:650), 1), # 500, 
	'tau.2' = 380, #sample(c(100:650), 1), # 500, 
	'tau.3' = 302, #sample(c(100:650), 1), # 300, 
	'tau.4' = 136, #sample(c(100:650), 1), # 400, 
	'tau.5' = 310, #sample(c(100:650), 1), # 200, 
	'tau.6' = 178, #sample(c(100:650), 1), # 400, 
	'tau.7' = 266, #sample(c(100:650), 1), # 400, 
	'tau.8' = 236, #sample(c(100:650), 1), # 350, 
	'tau.9' = 354, #sample(c(100:650), 1), # 350, 
	'tau.10' = 330, #sample(c(100:650), 1), # 350, 
	'tau.11' = 370, #sample(c(100:650), 1), # 350, 
	'mu.tau' = 265, 
	'sigma.tau' = 100, 
	'report' = 0.09, 
	'norm_var' = 0.1^2, 
	'epidur' = 70, #sample(c(30:150), 1), 
	'zeroprevlevel' = 4, #sample(c(0:500), 1),
	'immig' = 50 #sample(seq(10, 500, by = 10), 1)
	)
...
if (file.num > 1) {
	...
	load(paste('~/work/Infl_VN/MCMC_0501/MCMC_svna/MCMC_svna_0501_', file.num-1, '.Rdata', sep = ''))
	...
	# load('~/work/Infl_VN/MCMC_0501/MCMC_svna/MCMC_svna_0509.Rdata')
	load('~/work/Infl_VN/MCMC_0501/MCMC_svna/MCMC_svna_0501_0.Rdata')

	start.pars = list()
	for (i in 1:4) {
		ss = sample(c(1, 3, 4), 1); ss = i
...
file.name = paste('~/work/Infl_VN/MCMC_0501/MCMC_svna/MCMC_svna_0501_', file.num, '.Rdata', sep = '')
...
if (file.num >= 3) { 
	...
	all.data = list()
	load('~/work/Infl_VN/MCMC_0501/MCMC_svna/MCMC_svna_0501_1.Rdata')
	...
	for (i in 2:file.num) {
		...
		load(paste('~/work/Infl_VN/MCMC_0501/MCMC_svna/MCMC_svna_0501_', i, '.Rdata', sep = ''))
	...
	save(all.data, file = paste('~/work/Infl_VN/MCMC_0501/MCMC_svna/MCMC_svna_0501.Rdata', sep = ''))
...
type = 'svna'; source('~/work/Infl_VN/MCMC_0501/Code/plotting.R')
