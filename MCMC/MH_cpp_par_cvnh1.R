...
if (file.num > 1) {
	...
	load(paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh1/MCMC_cvnh1_0501_', file.num-1, '.Rdata', sep = ''))
	...
	# load('~/work/Infl_VN/MCMC_0501/MCMC_cvnh1/MCMC_cvnh1_0509.Rdata')
	load('~/work/Infl_VN/MCMC_0501/MCMC_cvnh1/MCMC_cvnh1_0501_0.Rdata')

	start.pars = list()
	for (i in 1:4) {
		ss = sample(c(1, 2, 4), 1); ss = i
...
file.name = paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh1/MCMC_cvnh1_0501_', file.num, '.Rdata', sep = '')

search_params_names = c('beta_H1', 'amp', 'rho_denom', 
   	'phi.1', 'tau.1', 'tau.2', 'tau.3', 'tau.4', 'tau.5', 'tau.6', 'tau.7', 
...
mv.pars = list(c('beta_H1'), c('amp'), c('rho_denom'), c('phi.1'), 
	c('tau.1', 'tau.2', 'tau.3', 'tau.4', 'tau.5', 'tau.6', 'tau.7'), 
...
if (file.num >= 3) { 
	...
	all.data = list()
	load('~/work/Infl_VN/MCMC_0501/MCMC_cvnh1/MCMC_cvnh1_0501_1.Rdata')
	...
	for (i in 2:file.num) {
		...
		load(paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh1/MCMC_cvnh1_0501_', i, '.Rdata', sep = ''))
	...
	save(all.data, file = paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh1/MCMC_cvnh1_0501.Rdata', sep = ''))
...
type = 'cvnh1'; source('~/work/Infl_VN/MCMC_0501/Code/plotting.R')
