...
if (file.num > 1) {
	...
	load(paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh1/MCMC_nvnh1_0501_', file.num-1, '.Rdata', sep = ''))
	...
	# load('~/work/Infl_VN/MCMC_0501/MCMC_nvnh1/MCMC_nvnh1_0509.Rdata')
	load('~/work/Infl_VN/MCMC_0501/MCMC_nvnh1/MCMC_nvnh1_0501_0.Rdata')
...
file.name = paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh1/MCMC_nvnh1_0501_', file.num, '.Rdata', sep = '')
...
pp = MH_chain(ch.num = 0, chain.length = 200, 
	...
	use.cur = use.cur,
	type = 'nvnh1', 
	dat = as.matrix(cbind(dat$ILI_p_H1, rep(NA, nrow(dat)), rep(NA, nrow(dat)))))
...
if (file.num >= 3) { 
	...
	all.data = list()
	load('~/work/Infl_VN/MCMC_0501/MCMC_nvnh1/MCMC_nvnh1_0501_1.Rdata')
	...
	for (i in 2:file.num) {
		...
		load(paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh1/MCMC_nvnh1_0501_', i, '.Rdata', sep = ''))
	...
	save(all.data, file = paste('~/work/Infl_VN/MCMC_0501/MCMC_nvnh1/MCMC_nvnh1_0501.Rdata', sep = ''))
...
type = 'nvnh1'; source('~/work/Infl_VN/MCMC_0501/Code/plotting.R')
