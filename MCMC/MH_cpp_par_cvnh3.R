...
if (file.num > 1) {
	...
	load(paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh3/MCMC_cvnh3_0501_', file.num-1, '.Rdata', sep = ''))
	...
	load('~/work/Infl_VN/MCMC_0501/MCMC_cvnh3/MCMC_cvnh3_0509.Rdata')
	# load('~/work/Infl_VN/MCMC_0501/MCMC_cvnh3/MCMC_cvnh3_0501_0.Rdata')
...
file.name = paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh3/MCMC_cvnh3_0501_', file.num, '.Rdata', sep = '')
...
if (file.num >= 3) { 
	...
	all.data = list()
	load('~/work/Infl_VN/MCMC_0501/MCMC_cvnh3/MCMC_cvnh3_0501_1.Rdata')
	...
	for (i in 2:file.num) {
		...
		load(paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh3/MCMC_cvnh3_0501_', i, '.Rdata', sep = ''))
	...
	save(all.data, file = paste('~/work/Infl_VN/MCMC_0501/MCMC_cvnh3/MCMC_cvnh3_0501.Rdata', sep = ''))
...
type = 'cvnh3'; source('~/work/Infl_VN/MCMC_0501/Code/plotting.R')
